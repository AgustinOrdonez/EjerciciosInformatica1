...
/**
 * \fn int abrirConeccion ( struct sockaddr_in * my_addr)
...
int abrirConeccion(struct sockaddr_in *my_addr) {
...
/* Asignamos valores a la estructura my_addr */
    ...
    /*Para reusar el socket instant, lo hizo el profe*/
    int optval = 1;
